function gpm_1d_10(numRepetitions, numPoints, mean_bins, std_bins, saveBoxPlot2File, outputFileName, ouputFolder)
...
for i = 1:numRepetitions,    
    ...
    std = [rand*10, rand*10]; % std uniform between 0 and 10
    ...
    gmm_fit = fitgmdist(pts, 2, 'RegularizationValue', 0.001);
    em_timer = toc;
